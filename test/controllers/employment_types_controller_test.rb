...
class EmploymentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employment_type" do
    assert_difference('EmploymentType.count') do
      post employment_types_url, params: { employment_type: { attendance_rate: @employment_type.attendance_rate, description: @employment_type.description, name: @employment_type.name } }
    end
  ...
  test "should update employment_type" do
    patch employment_type_url(@employment_type), params: { employment_type: { attendance_rate: @employment_type.attendance_rate, description: @employment_type.description, name: @employment_type.name } }
